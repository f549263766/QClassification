...
def build_dataset(cfg, default_args=None):
    """use 'mmcv.utils.Registry' map module and return dataset wrapper.
    Args:
        cfg (dict, required): Config dict. It should at least contain the key "type".
        default_args (dict, optional): Default initialization arguments.
    Return:
        :dataset: The corresponding dataset with cfg['type']
    """
    from .dataset_wrappers import (ClassBalanceDatasets, ConcatDataset, KFoldDataset, RepeatDataset)
...
def build_dataloader(dataset,
    ...
    Args:
        dataset (Dataset, required): A PyTorch dataset.
        samples_per_gpu (int, required): Number of training samples on each GPU, i.e., batch size of each GPU.
        workers_per_gpu (int, required): How many subprocesses to use for data loading for each GPU.
        ...
        shuffle (bool, optional): Whether to shuffle the data at every epoch.
            Default to True.
        round_up (bool, optional): Whether to round up the length of dataset by adding
            extra samples to make it evenly divisible.
            Default to True.
        seed (int, optional): The seed to random.
            Default to None.
        pin_memory (bool, optional): Whether to use pin_memory in DataLoader.
            Default to True
        persistent_workers (bool, optional): If True, the data loader will not shutdown
            ...
            Default to True
        sampler_cfg (dict, optional): The sampler configuration to override the default sampler.
            Default to None.
